...
const page = () => {
  ...
  return (
    <>
      ...
      <div className=" w-full  min-h-screen flex flex-col-reverse md:flex-row  text-white mt-16 md:mt-9 gap-6 p-5 md:p-8 pb-24 mb-8 max-h-full overflow-auto">
        {loading ? (
                ...
                <Table>
                  ...
                  <TableBody className=" ">
                    <TableRow className="">
                      ...
                      <TableCell className="  max-w-[140px] w-full font-bold capitalize text-xs py-5 border-b border-gray-700 2xl:text-base   ">
        ...
        <div className="   md:w-[40%] flex flex-col gap-4 mb-8  ">
          <div className="shadow-inner shadow-gray-800 px-5 py-10  flex flex-col gap-2.5 rounded-xl  bg-[#181926] relative">
            ...
            <button className=" w-full py-2.5 rounded-lg my-3 inner-shadow font-bold">
              JOIN DISCORD
            </button>
          </div>
          <div className="flex gap-4 ">
            <div className="shadow-inner  md:mb-16 flex-grow  shadow-gray-800 p-7  items-center justify-center flex flex-col gap-2.5 rounded-xl  bg-[#181926]">
              <Image
            ...
            <div className="shadow-inner  md:mb-16  flex-grow items-center justify-center  shadow-gray-800 p-7  flex flex-col gap-2.5 rounded-xl  bg-[#181926]">
              <Image
